...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments = new Fragment[]{conversationListFragment, contactListFragment, settingFragment, discoverFragment};

        getSupportFragmentManager().beginTransaction()
                .add(R.id.layout_viewpage, conversationListFragment)
                .add(R.id.layout_viewpage, contactListFragment)
...
//		unreadAddressLable = (TextView) findViewById(R.id.unread_address_number);
        mTabs = new Button[4];
        mTabs[0] = (Button) findViewById(R.id.btn_weixin);
    ...
    public void onTabClicked(View view) {
        ...
        if (currentTabIndex != index) {
            ...
            if (!fragments[index].isAdded()) {
                trx.add(R.id.layout_viewpage, fragments[index]);
            }
