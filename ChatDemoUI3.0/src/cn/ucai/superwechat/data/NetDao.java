...
public class NetDao {
    ...
    public static void addUser(Context context, String username,String cname, OkHttpUtils.OnCompleteListener<String> listener){
        OkHttpUtils<String> utils = new OkHttpUtils<>(context);
    ...
    public static void deleteUser(Context context, String username,String cname, OkHttpUtils.OnCompleteListener<String> listener){
        OkHttpUtils<String> utils = new OkHttpUtils<>(context);
